...
These trees have in common that they store state for _all_ accounts on the Aztec network directly as leaves. This is different from Ethereum, where a state tree contains smaller trees that hold the individual accounts' storage.
